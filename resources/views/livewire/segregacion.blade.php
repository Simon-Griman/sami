                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">    
                                    <div class="mb-3">
                                        <label for="nombre" class="col-form-label">Nombre de la Segregación:</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="hidrocarburo" class="col-form-label">Nombre del Hidrocarburo:</label>
                                        <select name="hidrocarburo" id="hidrocarburo" class="form-control @error('hidrocarburo') is-invalid @enderror" wire:model.defer="hidrocarburo" require value="{{ old('hidrocarburo') }}">
                                ...
                                <div class="modal-footer">
                                    ...
                                    @if($crear)
                                    <button type="submit" class="btn btn-primary" wire:click.prevent="crear()">Enviar</button>
                                    @else
                ...
                <div class="modal fade" id="borrar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>¿Realmente desea borrar <b>{{ $segregacion_borrar }}</b> de la lista?</h5>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
